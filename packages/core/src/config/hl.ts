...
let metadataCache: HyperliquidMetadataCache = new DefaultHyperliquidMetadataCache();

export function replaceMetadataCache(options: HyperliquidMetadataCacheOptions = {}): HyperliquidMetadataCache {
...
export function replaceTransport(nextTransport: IRequestTransport = new HttpTransport()): InfoClient {
