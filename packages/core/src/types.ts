...
export type SpotMeta = Awaited<ReturnType<InfoClient["spotMetaAndAssetCtxs"]>>[0];
export type SpotAssetContexts = Awaited<ReturnType<InfoClient["spotMetaAndAssetCtxs"]>>[1];
...
export type MetaAndAssetCtxs = Awaited<ReturnType<InfoClient["metaAndAssetCtxs"]>>;
...
export type UserTwapFill = Awaited<ReturnType<InfoClient["userTwapSliceFills"]>>[number];
export type ActiveAssetData = Awaited<ReturnType<InfoClient["activeAssetData"]>>;
...
export type HyperliquidTwapFill = Omit<UserTwapFill["fill"], "coin" | "side"> & {
    coin: string;
    side: "BUY" | "SELL";
    marketType: HyperliquidMarketType;
